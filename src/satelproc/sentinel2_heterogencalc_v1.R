...
workingdirectory="O:/Nat_Ecoinformatics-tmp/au700510_2022_1/satelliteprocess/sentinel2/Jan20_sent2_ndvi/"
...
for (i in filelist) {
  ...
  radarraster=stack(i)
  writeRaster(radarraster, filename=paste("O:/Nat_Ecoinformatics-tmp/au700510_2022_1/satelliteprocess/sentinel2/Jan20_sent2_ndvi/processed/",str_remove(i, ".tif"),"_",names(radarraster),sep=""), bylayer=TRUE,format="GTiff")
...
workingdirectory="O:/Nat_Ecoinformatics-tmp/au700510_2022_1/satelliteprocess/sentinel2/Jan20_sent2_ndvi/processed/"
setwd(workingdirectory)
...
for (j in feanames) {
  ...
  writeRaster(metric,paste("O:/Nat_Ecoinformatics-tmp/au700510_2022_1/satelliteprocess/sentinel2/Jan20_sent2_ndvi/processed/merged/",j,".tif",sep=""),overwrite=TRUE)
