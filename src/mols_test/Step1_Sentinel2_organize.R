...
workingdirectory="O:/Nat_Ecoinformatics-tmp/au700510_2022_1/satelliteprocess/Mols_test/Sentinel2_febr17/"
...
for (i in filelist) {
  ...
  radarraster=stack(i)
  writeRaster(radarraster, filename=paste("O:/Nat_Ecoinformatics-tmp/au700510_2022_1/satelliteprocess/Mols_test/Sentinel2_febr17/processed/",str_remove(i, ".tif"),"_",names(radarraster),sep=""), bylayer=TRUE,format="GTiff")
...
workingdirectory="O:/Nat_Ecoinformatics-tmp/au700510_2022_1/satelliteprocess/Mols_test/Sentinel2_febr17/processed/"
setwd(workingdirectory)
...
for (j in feanames) {
  ...
  writeRaster(metric,paste("O:/Nat_Ecoinformatics-tmp/au700510_2022_1/satelliteprocess/Mols_test/Sentinel2_febr17/processed/merged/",j,".tif",sep=""),overwrite=TRUE)
