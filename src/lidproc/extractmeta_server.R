...
inputdirectory="O:/Nat_Ecoinformatics/B_Read/LegacyData/Denmark/Elevation/GST_2014/Punktsky/laz/" #set this to the path where the laz (unzipped) files are located 
outputdirectory="O:/Nat_Ecoinformatics-tmp/au700510/" #set this to the path where the resulted files wished to be extracted
lasinfoloc="C:/LAStools/bin/" #set this to the path where the lasinfo.exe file is located 
